...
const LOBBY_BANNER_PATH = join(__dirname, 'assets', 'pirate-lobby-banner.jpg');
...
function getLobbyBanner() {
  return new AttachmentBuilder(LOBBY_BANNER_PATH, { name: 'pirate-lobby-banner.jpg' });
}
